        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">@lang('manage/tags.create_new_tag')</div>
                    ...
                    <div class="panel-body">
                        ...
                        <form action="{{url('manage/tags')}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control" placeholder="@lang('manage/tags.name')">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-default">
                                    <i class="fa fa-btn fa-plus"></i>@lang('manage/tags.add_tag')
                                </button>
                            </div>
                        </form>
                    </div>
